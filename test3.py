...
def main():
        ...
        #for tm in range(times):
            ...
            for i,j in min_indices:
                ...
                if image_classifier.classify_sliced(img, slice_map) != image_classifier.type_pred:
                    ...
                    if ind < len(min_indices) and infer_map[min_indices[cri][0], min_indices[cri][1]] == infer_map[min_indices[ind][0], min_indices[ind][1]]:
                        cnt -= 1
                        #new_cnt = 0
                        slice_map[i,j] =1
                        print('ONE MORE TIME')
    ...
    fig.savefig('./result0113/slice.png')
